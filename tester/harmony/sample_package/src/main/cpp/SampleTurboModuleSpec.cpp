...
static jsi::Value __hostFunction_NativeSampleTurboCxxModuleSpecJSI_getArray(
    ...
    size_t count) {
  return jsi::Value(static_cast<ArkTSTurboModule&>(turboModule)
                        .call(rt, "getArray", args, count));
}

static jsi::Value
__hostFunction_NativeSampleTurboCxxModuleSpecJSI_registerFunction(
    jsi::Runtime& rt,
    react::TurboModule& turboModule,
    const jsi::Value* args,
    size_t count) {
  return jsi::Value(static_cast<ArkTSTurboModule&>(turboModule)
                        .call(rt, "registerFunction", args, count));
}
...
static jsi::Value __hostFunction_NativeSampleTurboCxxModuleSpecJSI_doAsyncJob(
    ...
    size_t count) {
  return jsi::Value(static_cast<ArkTSTurboModule&>(turboModule)
                        .callAsync(rt, "doAsyncJob", args, count));
}

static jsi::Value
__hostFunction_NativeSampleTurboCxxModuleSpecJSI_getPromisedArray(
    jsi::Runtime& rt,
    react::TurboModule& turboModule,
    const jsi::Value* args,
    size_t count) {
  return jsi::Value(static_cast<ArkTSTurboModule&>(turboModule)
                        .callAsync(rt, "getPromisedArray", args, count));
}
...
NativeSampleTurboModuleSpecJSI::NativeSampleTurboModuleSpecJSI(
  ...
  methodMap_["getNull"] = MethodMetadata{
      1, __hostFunction_NativeSampleTurboCxxModuleSpecJSI_getNull};
  ...
  methodMap_["registerFunction"] = MethodMetadata{
      1, __hostFunction_NativeSampleTurboCxxModuleSpecJSI_registerFunction};
  methodMap_["getPromisedArray"] = MethodMetadata{
      0, __hostFunction_NativeSampleTurboCxxModuleSpecJSI_getPromisedArray};
  methodMap_["doAsyncJob"] = MethodMetadata{
      0, __hostFunction_NativeSampleTurboCxxModuleSpecJSI_doAsyncJob};
