...
UIManagerModule::UIManagerModule(
  ...
  MethodMetadata getConstantsMetadata = {
      .argCount = 0, .invoker = getConstants};

  MethodMetadata getConstantsForViewManagerMetadata = {
      .argCount = 1, .invoker = getConstantsForViewManager};
...
std::vector<facebook::jsi::PropNameID> UIManagerModule::getPropertyNames(
...
facebook::jsi::Value UIManagerModule::getConstantsForViewManager(
    facebook::jsi::Runtime& rt,
    react::TurboModule& turboModule,
