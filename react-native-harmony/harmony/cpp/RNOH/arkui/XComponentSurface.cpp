...
namespace rnoh {
    ...
    public:
        ...
        ~SurfaceTouchEventHandler() override {
            NativeNodeApi::getInstance()->unregisterNodeEvent(m_rootView->getLocalRootArkUINode().getArkUINodeHandle(),
                                                              NODE_TOUCH_EVENT);
    ...
    XComponentSurface::XComponentSurface(std::shared_ptr<Scheduler> scheduler,
                                         ComponentInstanceRegistry::Shared componentInstanceRegistry,
                                         ComponentInstanceFactory::Shared componentInstanceFactory,
                                         SurfaceId surfaceId, std::string const &appKey)
        : m_surfaceId(surfaceId), m_scheduler(std::move(scheduler)), m_nativeXComponent(nullptr), m_rootView(nullptr),
        ...
        m_rootView = componentInstanceFactory->create(surfaceId, facebook::react::RootShadowNode::Handle(), "RootView");
    ...
    XComponentSurface::XComponentSurface(XComponentSurface &&other) noexcept
        : m_surfaceId(other.m_surfaceId), m_scheduler(std::move(other.m_scheduler)),
          m_nativeXComponent(other.m_nativeXComponent), m_rootView(std::move(other.m_rootView)),
    ...
    void XComponentSurface::updateConstraints(float width, float height, float viewportOffsetX, float viewportOffsetY,
                                              float pixelRatio) {
