...
void rnoh::setupTracing(jsi::Runtime &runtime) {
    ...
    runtime.global().setProperty(runtime, "nativeTraceIsTracing", nativeTraceIsTracing);
    runtime.global().setProperty(runtime, "nativeTraceBeginSection", nativeTraceBeginSection);
    runtime.global().setProperty(runtime, "nativeTraceEndSection", nativeTraceEndSection);
    runtime.global().setProperty(runtime, "nativeTraceBeginAsyncSection", nativeTraceBeginAsyncSection);
    runtime.global().setProperty(runtime, "nativeTraceEndAsyncSection", nativeTraceEndAsyncSection);
    runtime.global().setProperty(runtime, "nativeTraceCounter", nativeTraceCounter);
}
