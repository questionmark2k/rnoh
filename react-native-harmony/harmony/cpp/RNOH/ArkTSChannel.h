...
namespace rnoh {
    ...
    public:
        ...
        ArkTSChannel(TaskExecutor::Shared taskExecutor, ArkJS arkJs, napi_ref napiEventDispatcherRef)
            : m_arkJs(arkJs), m_napi_event_dispatcher_ref(napiEventDispatcherRef), m_taskExecutor(taskExecutor) {}
